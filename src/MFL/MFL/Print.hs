...
instance Print MFL.Abs.TokUnit where
  prt _ (MFL.Abs.TokUnit (_,i)) = doc $ showString i
instance Print MFL.Abs.UIdent where
  prt _ (MFL.Abs.UIdent (_,i)) = doc $ showString i
instance Print MFL.Abs.PIdent where
  prt _ (MFL.Abs.PIdent (_,i)) = doc $ showString i
instance Print MFL.Abs.PInteger where
  prt _ (MFL.Abs.PInteger (_,i)) = doc $ showString i
