...
@rsyms = \% "module" | \% "data" | \= | \{ | \} | \% "newtype" | \; | \% "rec" | \: \: | \@ | \\ | \- \> | \% "let" | \% "in" | \% "case" | \% "of" | \% "coerce" | \% "note" | \% "external" | \( | \) | \% \_ | \% "forall" | \. | \* | \# | \?
...
resWords =
  b "%rec" 14
    (b "%forall" 7
       (b "%coerce" 4
          (b "%_" 2 (b "#" 1 N N) (b "%case" 3 N N))
          (b "%external" 6 (b "%data" 5 N N) N))
       (b "%newtype" 11
          (b "%let" 9 (b "%in" 8 N N) (b "%module" 10 N N))
          (b "%of" 13 (b "%note" 12 N N) N)))
    (b ";" 21
       (b "->" 18
